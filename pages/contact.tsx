            ...
            <Layout>
                <div className="flex flex-col justify-center sm:items-start mt-5 w-full md:w-2/3 pl-8">
                    ...
                    <div className="mt-8 w-full flex flex-col space-y-4 pr-5">
                        <input type="email" placeholder="email" required className="font-fira text-sm bg-transparent border-slate-600 border rounded p-2 focus:outline-none dark:focus-within:bg-[#35404E] dark:hover:bg-[#35404E] duration-100 transition-bg" />
